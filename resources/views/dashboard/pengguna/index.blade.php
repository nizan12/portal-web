                ...
                <form id="linkForm" action="{{ route('pengguna.links.store') }}" method="POST">
                    ...
                    <div class="premium-modal-form-group">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <button type="button" onclick="toggleUserQuickCategoryForm()" class="text-[11px] font-bold flex items-center gap-1 cursor-pointer" style="background: none; border: none; padding: 0; color: var(--orange);">
